...
from google_travel_time_comparison.config import TRAVELTIME_APP_ID_VAR_NAME, TRAVELTIME_API_KEY_VAR_NAME, \
...
def test_retrieve_traveltime_credentials_missing_app_id(monkeypatch):
    ...
    with pytest.raises(ValueError, match="TravelTime API credentials are missing from environment variables."):
        retrieve_traveltime_credentials()
